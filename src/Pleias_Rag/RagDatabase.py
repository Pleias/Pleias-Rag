...
from .database_chunking_strategies import chunk_text  # This function takes max_segment as parameter
...
class RagDatabase:
    ...
    def __init__(
        ...
        Args:
            ...
            default_max_segment: Default maximum segment length for chunking, defaults to 300.
        """
    ...
    def add_pre_chunked_documents(
        ...
        """
        Add pre-chunked documents directly to both lists. Each chunk becomes its own document
        and its own chunked document with the same ID.
        
        Args:
            chunks: List of pre-chunked text strings
        ...
        for chunk in chunks:
            ...
            # Add as chunked document (using same ID as parent)
